...
public class DoctorNowhereModEntities {
	...
	public static final RegistryObject<EntityType<TheLocustEntity>> THE_LOCUST = register("the_locust",
			EntityType.Builder.<TheLocustEntity>of(TheLocustEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TheLocustEntity::new).fireImmune().sized(1f, 5f));
	...
	public static final RegistryObject<EntityType<BoiledOnePhenomenonEntity>> BOILED_ONE_PHENOMENON = register("boiled_one_phenomenon", EntityType.Builder.<BoiledOnePhenomenonEntity>of(BoiledOnePhenomenonEntity::new, MobCategory.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(300).setUpdateInterval(3).setCustomClientFactory(BoiledOnePhenomenonEntity::new).fireImmune().sized(1.2f, 6f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(BOILED_ONE_PHENOMENON.get(), BoiledOnePhenomenonEntity.createAttributes().build());
	}
}
