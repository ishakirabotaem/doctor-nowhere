				...
				if (entity instanceof GuiltEntity) {
					...
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("doctor_nowhere:entity.guilt.talk")), SoundSource.MASTER, 1, 1);
						} else {
